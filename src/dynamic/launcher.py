...
def process_args(args, defaults):
  ...
  parser.add_argument('--no-gradient_clipping', dest='clip_gradients',
                      action='store_false',
                      help=(
                          'Do not perform gradient clipping, difault for clip_gradients is %s' %
